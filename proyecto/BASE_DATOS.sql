...
SELECT COMENTARIOS.*,usuarios.IMAGEN,usuarios.NAME FROM COMENTARIOS LEFT JOIN usuarios ON usuarios.EMAIL = comentarios.USUARIO_ID WHERE TIPO_MSJ=1 ORDER BY comentarios.FECHA;
